...
export const REMOTE_WORKER_CONTROL_PLANE_PORT = parseInt(
  getEnv('REMOTE_WORKER_CONTROL_PLANE_PORT') || '8787',
  10,
);
export const REMOTE_WORKER_CONTROL_PLANE_HOST =
  getEnv('REMOTE_WORKER_CONTROL_PLANE_HOST') || '127.0.0.1';
export const REMOTE_WORKER_CONTROL_PLANE_TOKEN =
  getEnv('REMOTE_WORKER_CONTROL_PLANE_TOKEN') || '';
export const REMOTE_WORKER_CONTROL_PLANE_ENABLED =
  getEnv('REMOTE_WORKER_CONTROL_PLANE_ENABLED') === 'true' ||
  REMOTE_WORKER_CONTROL_PLANE_TOKEN.length > 0;
